...
cv2.namedWindow('img_final_bin',cv2.WINDOW_NORMAL)
...
nz = cv2.countNonZero(img_final_bin);
...
if len(blobs)>1:
    print('Multiple Tables of different template')
